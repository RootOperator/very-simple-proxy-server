...
pub trait Middleware {
    ...
    fn before_request(&mut self, _req: &mut Request<Body>, _ctx: &ServiceContext, _state: &State) -> 
        Result<MiddlewareResult, MiddlewareError>
    {
        Ok(Next)
    }

    fn after_request(&mut self, _res: Option<&mut Response<Body>>, _ctx: &ServiceContext, _state: &State) -> 
        Result<MiddlewareResult, MiddlewareError>
    {
        Ok(Next)
    }
